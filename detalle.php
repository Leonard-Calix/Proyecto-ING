...
<head>
	...
	<link rel="stylesheet" href="css/codepen-embed.css">
		...
		<div class="container">
			...
			<a class="navbar-brand" href="index.html">
				<svg class="navbar-brand-svg" viewBox="0 0 245 80" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
					...
					<text x="40" y="70" font-family="Arial, sans-serif" font-size="60" font-weight="bold" letter-spacing="-.025em" fill="currentColor">NOMBRE SITIO</text>
				</svg>
			</a>
      ...
      <div class="row">
        <div  class="col-md-12">
         ...
         <div class="card-img-top">
          <img src="img/02.jpg" alt="App landing" class="img-fluid">
      </div>
      ...
      <div class="card-body">
       ...
       <div class="row" >
           <div class="col-md-1 col-sm-1 col-xs-1 col-1">
            <span><img class="rounded-circle foto-perfil" src="img/1.jpg"></span>
        </div>
...
<div class="row">
   <div class="col-md-1 col-1 mr-1">
    <span><img class="rounded-circle foto-perfil mr-2" src="img/2.jpg"></span>
</div>
<div class="col-md-10  col-10">
    <div class="p-2 mb-2 color-comentario" >
     <small class="text-muted">
      <span class="text-primary"><b>Cristiano Ronaldo</b></span> 
      Exelente, mis mejores vacaciones
  </small>			
</div>
</div>
</div>
...
<!-- / .Comentarios -->
    ...
    <!-- JAVASCRIPT
    	...
    	<script src="js/dist/fullpage.min.js"></script>
